...
ConfigError(){
	...
	IniRead, x1, Config.ini, Jug of Water, xmin
	IniRead, x2, Config.ini, Jug of Water, xmax
	IniRead, y1, Config.ini, Jug of Water, ymin
	IniRead, y2, Config.ini, Jug of Water, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG	
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Jug of Water] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Grapes, xmin
	IniRead, x2, Config.ini, Grapes, xmax
	IniRead, y1, Config.ini, Grapes, ymin
	IniRead, y2, Config.ini, Grapes, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG	
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Grapes] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep mix|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep mix|bank coords|grapes|jug of water|"
