...
ConfigError(){
	IniRead, x1, Config.ini, spinning wheel - fungal bowstring, xmin
	IniRead, x2, Config.ini, spinning wheel - fungal bowstring, xmax
	IniRead, y1, Config.ini, spinning wheel - fungal bowstring, ymin
	IniRead, y2, Config.ini, spinning wheel - fungal bowstring, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [spinning wheel - fungal bowstring] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep craft|spinning wheel|bank prime coords|bank main coords|sleep walk|sleep fungal|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|bank prime coords|bank main coords|sleep walk|spinning wheel|spinning wheel - fungal only|bank preset|sleep fungal|"
