...
ConfigError(){
	...
	IniRead, x1, Config.ini, Spinning Wheel, xmin
	IniRead, x2, Config.ini, Spinning Wheel, xmax
	IniRead, y1, Config.ini, Spinning Wheel, ymin
	IniRead, y2, Config.ini, Spinning Wheel, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Spinning Wheel] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|item config|sleep walk|sleep craft|scroll|spinning wheel - fungal only|sleep fungal|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|item config|sleep walk|sleep craft|scroll|bank prime coords|bank main coords|spinning wheel|spinning wheel - fungal only|sleep fungal|"
