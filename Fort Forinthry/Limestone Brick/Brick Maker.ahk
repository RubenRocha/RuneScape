...
ConfigError(){
	...
	IniRead, x1, Config.ini, Stonecutter, xmin
	IniRead, x2, Config.ini, Stonecutter, xmax
	IniRead, y1, Config.ini, Stonecutter, ymin
	IniRead, y2, Config.ini, Stonecutter, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Stonecutter] in the config.
		reload
	}
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep walk|sleep cut|bank prime|bank main|stonecutter|"
