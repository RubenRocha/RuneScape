...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep disassemble|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep disassemble|item|"
...
{ 
	...
	IniRead, saf1, Config.ini, Sleep Disassemble, min
	IniRead, saf2, Config.ini, Sleep Disassemble, max
