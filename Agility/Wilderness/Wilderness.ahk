...
ConfigError(){
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Obstacle Pipe Prime] in the config.
		reload
	}
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Obstacle Pipe Main] in the config.
		reload
	}
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Ropeswing] in the config.
		reload
	}
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Stepping Stone] in the config.
		reload
	}
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Cliffside] in the config.
		reload
	}
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|obstacle pipe prime|obstacle pipe main|ropeswing|stepping stone|log balance|cliffside|"
