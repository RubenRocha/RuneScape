...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep add|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep add|bank coords|"
...
{ 	
	...
	IniRead, sa1, Config.ini, Sleep Add, min
	IniRead, sa2, Config.ini, Sleep Add, max
	Random, SleepAmount, %sa1%, %sa2%
	Sleep, %SleepAmount%
}
