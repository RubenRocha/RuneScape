...
ConfigError(){
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for selected item [Bow Type] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|bow type|sleep fletch|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|bow type|sleep fletch|bank coords|Arrow shaft|Shortbow|Shieldbow|Oak shortbow|Oak shieldbow|Willow shortbow|Willow shieldbow|Maple shortbow|Maple shieldbow|Yew shortbow|Yew shieldbow|Magic shortbow|Magic shieldbow|Wooden Stock|Oak Stock|Willow Stock|Teak Stock|Maple Stock|Mahogany Stock|Yew Stock|Blisterwood Stock|Magic Stock|Unstrung Comp Bow|Teak Stock|Mahogany stock|Elder arrow shaft|Elder shortbow|Elder shieldbow|Blisterwood orb|Blisterwood polearm|Blisterwood sickle|Blisterwood staff|Blisterwood stake-thrower crossbow|Blisterwood stock|Blisterwood wand|Off-hand blisterwood sickle|Off-hand blisterwood stake|"
