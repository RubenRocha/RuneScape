...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep grind|"
...
{ 
	...
	IniRead, sa1, Config.ini, Sleep Grind, min
	IniRead, sa2, Config.ini, Sleep Grind, max
	Random, SleepAmount, %sa1%, %sa2%
	Sleep, %SleepAmount%
}
