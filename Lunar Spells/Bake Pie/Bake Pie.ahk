...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep bake|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep bake|bank coords|"
...
{ 
	...
	IniRead, saf1, Config.ini, Sleep Bake, min
	IniRead, saf2, Config.ini, Sleep Bake, max
