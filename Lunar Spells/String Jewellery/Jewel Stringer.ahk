...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep string|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep string|bank coords|"
...
{ 
	...
	IniRead, saf1, Config.ini, Sleep String, min
	IniRead, saf2, Config.ini, Sleep String, max
