...
ConfigError(){
	...
	IniRead, x1, Config.ini, Fletcher, xmin
	IniRead, x2, Config.ini, Fletcher, xmax
	IniRead, y1, Config.ini, Fletcher, ymin
	IniRead, y2, Config.ini, Fletcher, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Fletcher] in the config.
		reload
	}
	...
	if (item = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter a valid item for [Bow Type] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep walk|sleep fletch|renew|bow type|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|renew|sleep walk|bank|bank main coords|fletcher|sleep fletch|bow type|Arrow shaft|Shortbow|Shieldbow|Oak shortbow|Oak shieldbow|Willow shortbow|Willow shieldbow|Maple shortbow|Maple shieldbow|Yew shortbow|Yew shieldbow|Magic shortbow|Magic shieldbow|Wooden Stock|Oak Stock|Willow Stock|Teak Stock|Maple Stock|Mahogany Stock|Yew Stock|Blisterwood Stock|Magic Stock|Unstrung Comp Bow|Teak Stock|Mahogany stock|Elder arrow shaft|Elder shortbow|Elder shieldbow|Blisterwood orb|Blisterwood polearm|Blisterwood sickle|Blisterwood staff|Blisterwood stake-thrower crossbow|Blisterwood stock|Blisterwood wand|Off-hand blisterwood sickle|Off-hand blisterwood stake|"
