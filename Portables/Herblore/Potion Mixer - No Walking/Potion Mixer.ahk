...
ConfigError(){
	...
	IniRead, x1, Config.ini, Well, xmin
	IniRead, x2, Config.ini, Well, xmax
	IniRead, y1, Config.ini, Well, ymin
	IniRead, y2, Config.ini, Well, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Well] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep mix|sleep walk|renew|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|renew|sleep walk|bank prime coords|bank|well|sleep mix|"
