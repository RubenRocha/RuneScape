...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep fire|sleep craft|sleep walk|bank fire preset|renew|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep walk|renew|sleep fire|bank prime coords|bank|crafter|pottery menu coords|pottery sub-menu coords|"
