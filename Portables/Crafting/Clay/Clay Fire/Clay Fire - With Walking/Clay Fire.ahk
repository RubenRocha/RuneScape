...
ConfigError(){
	...
	if (hkbank = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter a valid hotkey for [Bank Fire Preset] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|bank fire preset|sleep walk|sleep fire|renew|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep walk|renew|sleep fire|bank prime coords|bank main coords|crafter coords|pottery menu coords|pottery sub-menu coords|"
...
IniRead, chance, LLARS Config.ini, Random Sleep, chance
IniRead, hk, Config.ini, Bank Fire Preset, hotkey
IniRead, clickchance, LLARS Config.ini, Random Right-Click, chance
...
Gui 20: Font, Norm
Gui 20: Add, Text, Center w220 x5,Start: %lhk1%`nCoordinates/Pause: %lhk2%`nHotkey/Resume: %lhk3%`nExit: %lhk4%`nBank Fire Preset: %hk%
