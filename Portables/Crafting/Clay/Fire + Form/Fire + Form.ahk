...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|item config|bank form preset|sleep form|sleep fire|sleep walk|renew|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep walk|renew|sleep fire|bank prime coords|bank|crafter|pottery menu coords|pottery sub-menu coords|item config|sleep form|cracked|fragile|plain|strong|decorated|impious|accursed|infernal|pot|clay ring|pie dish|bowl|plant pot|pot lid|"
...
IniRead, chance, LLARS Config.ini, Random Sleep, chance
IniRead, hk, Config.ini, Bank Form Preset, hotkey
IniRead, clickchance, LLARS Config.ini, Random Right-Click, chance
...
Gui 20: Font, Norm
Gui 20: Add, Text, Center w220 x5,Start: %lhk1%`nCoordinates/Pause: %lhk2%`nHotkey/Resume: %lhk3%`nExit: %lhk4%`nBank Form Preset: %hk%
