...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|item config|bank form preset|sleep walk|sleep form|renew|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep walk|renew|sleep fire|bank prime coords|bank main coords|crafter coords|pottery menu coords|pottery sub-menu coords|item config|sleep form|cracked|fragile|plain|strong|decorated|impious|accursed|infernal|pot|clay ring|pie dish|bowl|plant pot|pot lid|"
