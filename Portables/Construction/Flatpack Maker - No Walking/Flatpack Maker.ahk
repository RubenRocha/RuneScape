...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep walk|renew|sleep fire|bank prime coords|bank|workbench|pottery menu coords|Flatpack - Menu|Flatpack - item|sleep construct|flatpack - sub-menu|"
