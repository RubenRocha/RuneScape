...
ConfigError(){
	...
	IniRead, x1, Config.ini, Workbench, xmin
	IniRead, x2, Config.ini, Workbench, xmax
	IniRead, y1, Config.ini, Workbench, ymin
	IniRead, y2, Config.ini, Workbench, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Workbench] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Flatpack - Menu, xmin
	IniRead, x2, Config.ini, Flatpack - Menu, xmax
	IniRead, y1, Config.ini, Flatpack - Menu, ymin
	IniRead, y2, Config.ini, Flatpack - Menu, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG	
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Flatpack - Menu] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Flatpack - Sub-Menu, xmin
	IniRead, x2, Config.ini, Flatpack - Sub-Menu, xmax
	IniRead, y1, Config.ini, Flatpack - Sub-Menu, ymin
	IniRead, y2, Config.ini, Flatpack - Sub-Menu, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG	
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Flatpack - Sub-Menu] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Flatpack - Item, xmin
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Flatpack - Item] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|bank preset|renew|sleep walk|sleep construct|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep walk|renew|sleep fire|bank prime coords|bank|workbench|pottery menu coords|Flatpack - Menu|Flatpack - item|sleep construct|flatpack - sub-menu|bank main|bank prime|"
