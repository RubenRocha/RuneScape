...
ConfigError(){
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Magestix] in the config.
		reload
	}
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Buy Tab] in the config.
		reload
	}
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Sell Tab] in the config.
		reload
	}
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Obelisk] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Hellfire Metal, xmin
	IniRead, x2, Config.ini, Hellfire Metal, xmax
	IniRead, y1, Config.ini, Hellfire Metal, ymin
	IniRead, y2, Config.ini, Hellfire Metal, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Hellfire Metal] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Blood of Orcus, xmin
	IniRead, x2, Config.ini, Blood of Orcus, xmax
	IniRead, y1, Config.ini, Blood of Orcus, ymin
	IniRead, y2, Config.ini, Blood of Orcus, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Blood of Orcus] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep infuse|offset - sell|offset - buy|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|bank coords|magestix|Obelisk|buy tab|sell tab|hellfire metal - buy|blood of orcus - buy|sleep infuse|blood of orcus - sell|hellfire metal - sell|offset - sell|offset - buy|"
