...
ConfigError(){
	...
	IniRead, y2, Config.ini, Range, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Range] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Unstable Protean Protein, xmin
	IniRead, x2, Config.ini, Unstable Protean Protein, xmax
	IniRead, y1, Config.ini, Unstable Protean Protein, ymin
	IniRead, y2, Config.ini, Unstable Protean Protein, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Unstable Protean Protein] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep cook|normal protean protein|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep cook|range|normal protean Protein|unstable protean Protein|"
