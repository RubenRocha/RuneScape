...
ConfigError(){
	...
	IniRead, x1, Config.ini, Unstable Protean Fletch Logs, xmin
	IniRead, x2, Config.ini, Unstable Protean Fletch Logs, xmax
	IniRead, y1, Config.ini, Unstable Protean Fletch Logs, ymin
	IniRead, y2, Config.ini, Unstable Protean Fletch Logs, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Unstable Protean Fletch Logs] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep fletch|skillbar hotkey|normal protean fletch logs|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep fletch|normal protean Fletch Logs|unstable protean Fletch Logs|"
