...
ConfigError(){
	...
	IniRead, x1, Config.ini, Normal Protean Fletch Logs, xmin
	IniRead, x2, Config.ini, Normal Protean Fletch Logs, xmax
	IniRead, y1, Config.ini, Normal Protean Fletch Logs, ymin
	IniRead, y2, Config.ini, Normal Protean Fletch Logs, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Normal Protean Fletch Logs] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep fletch|skillbar hotkey|unstable protean fletch logs|"
