...
ConfigError(){
	...
	IniRead, x1, Config.ini, Normal Protean Fletch/Burn, xmin
	IniRead, x2, Config.ini, Normal Protean Fletch/Burn, xmax
	IniRead, y1, Config.ini, Normal Protean Fletch/Burn, ymin
	IniRead, y2, Config.ini, Normal Protean Fletch/Burn, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Normal Protean Fletch/Burn] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep fletch|skillbar hotkey|unstable protean fletch/burn|"
