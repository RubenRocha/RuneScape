...
ConfigError(){
	IniRead, x1, Config.ini, Altar, xmin
	IniRead, x2, Config.ini, Altar, xmax
	IniRead, y1, Config.ini, Altar, ymin
	IniRead, y2, Config.ini, Altar, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Altar] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Unstable Protean Essence, xmin
	IniRead, x2, Config.ini, Unstable Protean Essence, xmax
	IniRead, y1, Config.ini, Unstable Protean Essence, ymin
	IniRead, y2, Config.ini, Unstable Protean Essence, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Unstable Protean Essence] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|skillbar hotkey|normal protean essence|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|normal protean Essence|unstable protean Essence|altar|"
