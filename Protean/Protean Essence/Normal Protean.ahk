...
ConfigError(){
	...
	IniRead, x1, Config.ini, Normal Protean Essence, xmin
	IniRead, x2, Config.ini, Normal Protean Essence, xmax
	IniRead, y1, Config.ini, Normal Protean Essence, ymin
	IniRead, y2, Config.ini, Normal Protean Essence, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Normal Protean Essence] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|skillbar hotkey|unstable protean essence|"
