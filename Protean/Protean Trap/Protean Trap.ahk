...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep trap|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep trap|"
...
{ 	
	...
	IniRead, sa1, Config.ini, Sleep Trap, min
	IniRead, sa2, Config.ini, Sleep Trap, max
