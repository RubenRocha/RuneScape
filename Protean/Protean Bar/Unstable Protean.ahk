...
ConfigError(){
	IniRead, x1, Config.ini, Anvil, xmin
	IniRead, x2, Config.ini, Anvil, xmax
	IniRead, y1, Config.ini, Anvil, ymin
	IniRead, y2, Config.ini, Anvil, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Anvil] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Unstable Protean Bar, xmin
	IniRead, x2, Config.ini, Unstable Protean Bar, xmax
	IniRead, y1, Config.ini, Unstable Protean Bar, ymin
	IniRead, y2, Config.ini, Unstable Protean Bar, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Unstable Protean Bar] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep smith|normal protean bar|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep smith|anvil|normal protean Bar|unstable protean Bar|"
