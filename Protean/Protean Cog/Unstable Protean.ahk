...
ConfigError(){
	...
	IniRead, x1, Config.ini, Unstable Protean Cog, xmin
	IniRead, x2, Config.ini, Unstable Protean Cog, xmax
	IniRead, y1, Config.ini, Unstable Protean Cog, ymin
	IniRead, y2, Config.ini, Unstable Protean Cog, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Unstable Protean Cog] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|skillbar hotkey|normal protean cog|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|normal protean cog|unstable protean cog|"
