...
ConfigError(){
	...
	IniRead, x1, Config.ini, Unstable Protean Shake, xmin
	IniRead, x2, Config.ini, Unstable Protean Shake, xmax
	IniRead, y1, Config.ini, Unstable Protean Shake, ymin
	IniRead, y2, Config.ini, Unstable Protean Shake, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Unstable Protean Shake] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep mix|skillbar hotkey|normal protean Shake|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep mix|normal protean Shake|unstable protean Shake|"
