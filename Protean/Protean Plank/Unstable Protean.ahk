...
ConfigError(){
	...
	IniRead, x1, Config.ini, Unstable Protean Plank, xmin
	IniRead, x2, Config.ini, Unstable Protean Plank, xmax
	IniRead, y1, Config.ini, Unstable Protean Plank, ymin
	IniRead, y2, Config.ini, Unstable Protean Plank, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Unstable Protean Plank] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|normal protean plank|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep craft|Workbench|normal protean plank|unstable protean plank|"
