...
ConfigError(){
	IniRead, x1, Config.ini, Energy Rift, xmin
	IniRead, x2, Config.ini, Energy Rift, xmax
	IniRead, y1, Config.ini, Energy Rift, ymin
	IniRead, y2, Config.ini, Energy Rift, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Energy Rift] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep convert|unstable protean memory|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep convert|energy rift|normal protean memory|unstable protean memory|"
...
{ 	
	...
	If firstrun = 0
	{
		...
		IniRead, sa1, Config.ini, Sleep Convert, min
		IniRead, sa2, Config.ini, Sleep Convert, max
		Random, SleepAmount, %sa1%, %sa2%
		Sleep, %SleepAmount%
	}	
}
