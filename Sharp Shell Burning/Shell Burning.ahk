...
ConfigError(){
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Sharp Shell Shard] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep burn|offset - shard|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|bank coords|magestix|Obelisk|buy tab|sell tab|hellfire metal - buy|blood of orcus - buy|sleep burn|sharp shell shard|offset - shard|"
