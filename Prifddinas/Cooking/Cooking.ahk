...
ConfigError(){
	...
	IniRead, x1, Config.ini, Bonfire Coords, xmin
	IniRead, x2, Config.ini, Bonfire Coords, xmax
	IniRead, y1, Config.ini, Bonfire Coords, ymin
	IniRead, y2, Config.ini, Bonfire Coords, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Bonfire Coords] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep walk|sleep cook|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep cook|sleep walk|bonfire coords|bank prime coords|bank main coords|"
