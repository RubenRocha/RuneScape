...
ConfigError(){
	IniRead, x1, Config.ini, Pool of Slime, xmin
	IniRead, x2, Config.ini, Pool of Slime, xmax
	IniRead, y1, Config.ini, Pool of Slime, ymin
	IniRead, y2, Config.ini, Pool of Slime, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Pool of Slime] in the config.
		reload
	}
	
	CoordMode, Mouse, Screen
	IniRead, x1, Config.ini, Bucket of Slime, xmin
	IniRead, x2, Config.ini, Bucket of Slime, xmax
	IniRead, y1, Config.ini, Bucket of Slime, ymin
	IniRead, y2, Config.ini, Bucket of Slime, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Bucket of Slime] in the config.
		reload
	}
	
	IniRead, x1, Config.ini, Magic Notepaper, xmin
	IniRead, x2, Config.ini, Magic Notepaper, xmax
	IniRead, y1, Config.ini, Magic Notepaper, ymin
	IniRead, y2, Config.ini, Magic Notepaper, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Magic Notepaper] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep collect|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep collect|pool of slime|bucket of slime|magic notepaper|"
...
{ 	
	...
	IniRead, sa1, Config.ini, Sleep Collect, min
	IniRead, sa2, Config.ini, Sleep Collect, max
