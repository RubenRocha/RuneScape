...
ConfigError(){
	...
	if (hk = "")
	{
		...
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter a valid hotkey for [Cape Hotkey] in the config.
		reload
	}
...
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|skillbar hotkey|bank preset|sleep clean|cape hotkey|"
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep clean|bank coords|"
...
IniRead, hkcape, Config.ini, Cape Hotkey, hotkey
IniRead, clickchance, LLARS Config.ini, Random Right-Click, chance
...
Gui 20: Font, Norm
Gui 20: Add, Text, Center w220 x5,Start: %lhk1%`nCoordinates/Pause: %lhk2%`nHotkey/Resume: %lhk3%`nExit: %lhk4%`nSkillbar: %hk%`nBank Preset: %hkbp%`nCape Hotkey: %hkcape%
